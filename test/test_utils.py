...
from utils.utils import get_next_weekday, compute_next_wednesday, get_sender_name, swap_players, generate_teams, flatten_args, exclude_maybe, format_teams, format_summary
...
class TestUtils(unittest.TestCase):
    ...
    def test_swap_players(self):
        ...
        self.assertEqual(new_teams, '{"black": ["Bob", "JaneDoe", "Alice"], "white": ["JohnDoe", "Charlie", "Eve"]}')
    ...
    def test_exclude_maybe(self):
        ...
        players = ['JohnDoe', 'JaneDoe', 'Alice%is%maybe%present', 'Bob', 'Charlie', 'Eve%is%maybe%present']
        self.assertEqual(exclude_maybe(players), ['JohnDoe', 'JaneDoe', 'Bob', 'Charlie'])
    ...
    def test_format_teams(self):
        ...
        teams = '{"black": ["JohnDoe", "JaneDoe", "Alice"], "white": ["Bob", "Charlie", "Eve"]}'
        self.assertEqual(format_teams(teams), '*SQUADRA NERA* \n - JohnDoe\n - JaneDoe\n - Alice\n\n*SQUADRA BIANCA* \n - Bob\n - Charlie\n - Eve\n')
    ...
    def test_format_summary(self):
        ...
        self.assertEqual(format_summary(all_players, day, time, target, default_message, pitch), expected_output)
        ...
        all_players = ['JohnDoe', 'JaneDoe', 'Alice%is%maybe%present', 'Bob', 'Charlie%is%maybe%present']
        day = 'Wednesday'
        time = '20:00'
        target = 6
        default_message = 'Default message'
