...
class TestEcho(unittest.TestCase):
    ...
    def test_echo(
        ...
        mock_is_already_present,
        mock_update_players_on_db,
        mock_update_teams_on_db,
        ...
        with self.subTest("aggiungimi - already present"):
            ...
            mock_is_already_present.assert_called_once_with(
                self.mock_update.message.chat_id, "@John"
            )
            self.assert_send_message_called_once_with("Ma @John, sei già nella lista")
        ...
        with self.subTest("aggiungimi - not present"):
            ...
            mock_is_already_present.assert_any_call(
                self.mock_update.message.chat_id, "@John"
            )
            mock_is_already_present.assert_any_call(
                self.mock_update.message.chat_id, "@John%is%maybe%present"
            )
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@John", "add"
            )
            self.assert_send_message_called_once_with("Ok, @John, ti aggiungo")
            ...
            mock_print_new_summary.assert_called_once_with(
                "formatted_summary", self.mock_update, self.mock_context
            )
            mock_update_bot_last_message_id_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, 123
            )
        ...
        with self.subTest("aggiungimi - not present - edit summary"):
            ...
            mock_edit_summary.assert_called_once_with(
                "formatted_summary", 123, self.mock_update, self.mock_context
            )
        ...
        with self.subTest("aggiungimi - not present - match full"):
            ...
            self.assert_send_message_called_once_with("Siete già in 3")
        ...
        with self.subTest("aggiungimi - not present - reached target"):
            ...
            mock_print_new_summary.assert_not_called()
            mock_update_bot_last_message_id_on_db.assert_not_called()
            mock_trigger_payment_reminder.assert_called_once_with(
                self.mock_update, self.mock_context, "day", "time"
            )
        ...
        with self.subTest("aggiungimi - maybe present confirmation"):
            ...
            mock_find_all_info_by_chat_id.side_effect = [
                (
                    ["@player1", "@player2", "@John%is%maybe%present"],
                    "day",
                    "time",
                    10,
                    "default_message",
            ...
            self.assert_send_message_called_once_with("Ok, @John, ti confermo")
            mock_update_players_on_db.assert_has_calls(
                [
                    call(
                        self.mock_update.message.chat_id,
                        "@John%is%maybe%present",
                        "remove",
                    ),
        ...
        with self.subTest("aggiungi - already present"):
            ...
            self.assert_send_message_called_once_with("@john è già nella lista")
        ...
        with self.subTest("aggiungi - not present"):
            ...
            self.assert_send_message_called_once_with("Ok, aggiungo @john")
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@john", "add"
            )
            mock_update_bot_last_message_id_on_db.assert_called_once_with(
        ...
        with self.subTest("proponimi - already maybe present"):
            ...
            self.assert_send_message_called_once_with("Ma @John, sei già in forse")
        ...
        with self.subTest("proponimi - not present"):
            ...
            self.assert_send_message_called_once_with("Ok, @John, ti propongo")
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@John%is%maybe%present", "add"
            )
            mock_update_bot_last_message_id_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, 123
            )
        ...
        with self.subTest("proponimi - present - becoming maybe present"):
            ...
            self.assert_send_message_called_once_with("Ok, @John, ti metto in forse")
            mock_update_players_on_db.assert_has_calls(
                [
        ...
        with self.subTest("proponi - not present"):
            ...
            self.assert_send_message_called_once_with("Ok, propongo @john")
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@john%is%maybe%present", "add"
            )
            mock_update_bot_last_message_id_on_db.assert_called_once_with(
        ...
        with self.subTest("proponi - present - becoming maybe present"):
            ...
            self.assert_send_message_called_once_with("Va bene, metto in forse @john")
            mock_update_players_on_db.assert_has_calls(
                [
                    call(self.mock_update.message.chat_id, "@john", "remove"),
                    call(
        ...
        with self.subTest("proponi - present - becoming maybe present - revoked teams"):
            ...
            mock_update_teams_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, None
            )
            mock_format_summary.assert_called_once_with(
                ["@player1", "@player2", "@john%is%maybe%present"],
                "day",
        ...
        with self.subTest("toglimi - not present"):
            ...
            self.assert_send_message_called_once_with("Non eri in lista neanche prima")
        ...
        with self.subTest("toglimi - present"):
            ...
            self.assert_send_message_called_once_with("Mamma mia... che paccaro")
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@John", "remove"
            )
            mock_format_summary.assert_called_once_with(
                ["@player1", "@player2"], "day", "time", 10, "default_message", "pitch"
            )
            mock_print_new_summary.assert_called_once_with(
                "formatted_summary", self.mock_update, self.mock_context
            )
        ...
        with self.subTest("toglimi - maybe present"):
            ...
            mock_update_players_on_db.assert_called_once_with(
                self.mock_update.message.chat_id, "@John%is%maybe%present", "remove"
            )
            mock_format_summary.assert_called_once_with(
                ["@player1", "@player2"], "day", "time", 10, "default_message", "pitch"
            )
        ...
        with self.subTest("toglimi - maybe present - revoked teams"):
            ...
            mock_format_summary.assert_called_once_with(
                ["@player1", "@player2"], "day", "time", 3, "default_message", "pitch"
            )
            mock_print_new_summary.assert_not_called()
            mock_update_bot_last_message_id_on_db.assert_not_called()
            mock_trigger_payment_reminder.assert_not_called()
        ...
        with self.subTest("scambia - y not present"):
            ...
            mock_find_all_info_by_chat_id.side_effect = [
                (
                    ...
                    "default_message",
                    "pitch",
                    {"black": ["@John"], "white": ["@player1", "@player2"]},
                    123,
                )
            ]
            ...
            mock_is_already_present.assert_any_call(
                self.mock_update.message.chat_id, "@player3"
            )
            self.assert_send_message_called_once_with("@player3 non c'è")
        ...
        with self.subTest("scambia - x not present"):
            ...
            mock_find_all_info_by_chat_id.side_effect = [
                (
                    ...
                    "default_message",
                    "pitch",
                    {"black": ["@player1", "@player2"], "white": ["@John"]},
                    123,
                )
            ]
            mock_is_already_present.side_effect = [False, True]
            ...
            self.assert_send_message_called_once_with("@john non c'è")
        ...
        with self.subTest("scambia - x and y in the same team"):
            ...
            mock_find_all_info_by_chat_id.side_effect = [
                (
                    ["@player1", "@player2", "@player3, @john"],
                    "day",
                    "time",
                    4,
                    "default_message",
                    "pitch",
                    {"black": ["@john", "@player2"], "white": ["@player1", "@player3"]},
                    123,
                )
            ]
            ...
            mock_is_already_present.assert_any_call(
                self.mock_update.message.chat_id, "@player2"
            )
            self.assert_send_message_called_once_with(
        ...
        with self.subTest("scambia - x and y present"):
            ...
            mock_is_already_present.assert_any_call(
                self.mock_update.message.chat_id, "@player1"
            )
            self.assert_send_message_called_once_with(
            ...
            mock_update_teams_on_db.assert_called_once_with(
                self.mock_update.message.chat_id,
                '{"black": ["@player1", "@player2"], "white": ["@john", "@player3"]}',
            )
            mock_trigger_payment_reminder.assert_not_called()
